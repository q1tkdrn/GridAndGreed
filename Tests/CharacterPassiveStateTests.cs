...
public static class CharacterPassiveStateTests
{
    ...
    public static void Main()
    {
        ...
        Check(new CharacterPassiveState(4).JudgeHealing == 3, "Bishop heals 3 after judgment");
        ...
        for (int id = 1; id <= 9; id++)
        {
            ...
            if (id != 4) Check(state.JudgeHealing == 0, "Judgment healing must not leak to other units");
